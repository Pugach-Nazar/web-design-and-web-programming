...
namespace WebApplication1.Controllers
{
    public class DevicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Color")] Device device)
        {
        ...
        public string Buy(Purchase purchase)
        {
            ...
            return "Дякуємо, " + purchase.Name + ", за купівлю"; 
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Color")] Device device)
        {
            if (id != device.Id)
            {
                return NotFound();
